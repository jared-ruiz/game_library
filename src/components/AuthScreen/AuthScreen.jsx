      ...
      <div className="flex flex-1 justify-center items-center max-w-6xl mx-auto py-10 pr-5 pl-5 bg-black/60 text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          <div className="flex-1 p-2 text-center md:text-left">
            <h2 className="font-bold text-2xl">Over 300k Games to Search From</h2>
            <p className="text-lg">Quick and easy game search so you can find what you are looking for and get back to logging!</p>
          </div>
          <div className="flex-1  text-center md:text-left">
            <img src="/game-1.jpg" alt='ffxiv_image'className="rounded-2xl"/>    
            <p className="flex mr-2 justify-end text-blue-400 font-bold">Final Fantasy XIV</p>  
          </div>
        </div>
      </div>
